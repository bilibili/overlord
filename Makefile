...
cleanup:
	...
	- rm -f /tmp/redis_cluster_node1.conf || true
	- rm dump.rdb appendonly.aof - 2>/dev/null || true
...
travis-run:
	...
	echo "yes" | redis-git/src/redis-cli --cluster create 127.0.0.1:7000 127.0.0.1:7001 127.0.0.1:7002 127.0.0.1:7003 127.0.0.1:7004 127.0.0.1:7005 --cluster-replicas 1
	sleep 5
